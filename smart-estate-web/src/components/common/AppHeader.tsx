    ...
    <header className="fixed top-0 left-0 right-0 z-50 px-3 sm:px-6 pt-2 pointer-events-none transition-all duration-300">
      <div className="max-w-[1440px] mx-auto h-[64px] px-5 sm:px-8 bg-white/75 dark:bg-[#0c0c0e]/75 backdrop-blur-2xl border border-white/40 dark:border-zinc-800/80 rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-[0_8px_30px_rgb(0,0,0,0.4)] flex items-center justify-between pointer-events-auto transition-all">
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <Link
            to="/properties"
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-full text-[12.5px] font-semibold text-zinc-600 dark:text-zinc-300 hover:text-rose-600 dark:hover:text-rose-400 hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-all"
            title="Yêu thích"
          >
            <Heart className="w-4 h-4 text-zinc-500 hover:text-rose-500" />
          ...
          <Link
            to="/dashboard/chat"
            className="relative w-8.5 h-8.5 rounded-full flex items-center justify-center text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-white hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-all"
            title="Tin nhắn"
          >
          ...
          <button
            onClick={toggleTheme}
            className="w-8.5 h-8.5 rounded-full flex items-center justify-center text-zinc-600 dark:text-zinc-400 hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-all"
            title={theme === "dark" ? "Chế độ sáng" : "Chế độ tối"}
          >
            {theme === "dark" ? <Sun className="w-4.5 h-4.5 text-zinc-200" /> : <Moon className="w-4.5 h-4.5 text-zinc-700" />}
          </button>
          ...
          <Link to="/post-listing" className="hidden sm:block">
            <Button
              variant="outline"
              size="sm"
              className="rounded-full text-[12.5px] font-bold border-zinc-300 dark:border-zinc-700 hover:bg-zinc-100 dark:hover:bg-zinc-800 h-8.5 px-3.5"
            >
          ...
          <Link to="/auth/login">
            <Button
              variant="default"
              size="sm"
              className="rounded-full bg-zinc-900 text-white hover:bg-zinc-800 dark:bg-white dark:text-zinc-950 dark:hover:bg-zinc-200 px-4 h-8.5 text-[12.5px] font-bold shadow-sm"
            >
              Đăng nhập
            </Button>
          </Link>
          ...
          {/* Mobile Menu Toggle */}
          <button
            className="lg:hidden w-8.5 h-8.5 rounded-full flex items-center justify-center text-zinc-700 dark:text-zinc-200 hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-all"
